...
CXTWindowList::CXTWindowList(CXTMDIFrameWnd* pMDIFrameWnd)
...
BOOL CXTWindowList::OnInitDialog() 
{
	...
	// Set the background color for the flicker-free list box.
	m_lboxWindows.SetBackColor(xtAfxData.clrWindow);
