...
public:
    ...
    // Summary: Call this member function to set the wrappable state for the menubar.
...
public:
	...
	//			menu bar button when using intelligent menus.  NOTE:  You will also need to
...
protected:
	...
	// Summary:	This member function gets the indices of all items currently visible.
