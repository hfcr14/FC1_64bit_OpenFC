...
public:
	...
	// Example: To customize, replace CreateBar delegate with your own version such as
	//			the one shown below:
    //          <pre>
	...
	// Example:	To customize, replace IsCustomizableCommand delegate with your own 
	//			version such as the one shown below.
	//			<pre>
    //          BOOL CMyApp::InitInstance()
    //          {
