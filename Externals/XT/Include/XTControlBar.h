...
//			the relevant messages that are received by the parent frame.
...
public:
	...
	// Summary: Call this member function to determine if context menus are enabled
	//			on the control bar.  
	bool HasContextMenu();
	...
	// Summary: This member function tells if this control bar will be visualized
	//			when dragging or the system will render it with a wire frame.  Default
