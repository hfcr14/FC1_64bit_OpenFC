...
// Summary: An RGB value that represents the XP base color.
#ifndef XPCOLOR_BASE
#define XPCOLOR_BASE						30
#endif//XPCOLOR_BASE

// Summary: An RGB value that represents the XP toolbar background color.
#ifndef XPCOLOR_BARFACE
#define XPCOLOR_BARFACE				XPCOLOR_BASE
#endif//XPCOLOR_BARFACE

// Summary: An RGB value that represents the XP menu item selected color.
#ifndef XPCOLOR_HIGHLIGHT
#define XPCOLOR_HIGHLIGHT					31
#endif//XPCOLOR_HIGHLIGHT

// Summary: An RGB value that represents the XP menu item selected border color.
#ifndef XPCOLOR_HIGHLIGHT_BORDER
#define XPCOLOR_HIGHLIGHT_BORDER			32
#endif//XPCOLOR_HIGHLIGHT_BORDER

// Summary: An RGB value that represents the XP menu item pushed color.
#ifndef XPCOLOR_HIGHLIGHT_PUSHED
#define XPCOLOR_HIGHLIGHT_PUSHED			33
#endif//XPCOLOR_HIGHLIGHT_PUSHED

// Summary: An RGB value that represents the XP menu item icon shadow.
#ifndef XPCOLOR_ICONSHADDOW
#define XPCOLOR_ICONSHADDOW					34
#endif//XPCOLOR_ICONSHADDOW

// Summary: An RGB value that represents the XP menu item disabled text color.
#ifndef XPCOLOR_GRAYTEXT
#define XPCOLOR_GRAYTEXT					35
#endif//XPCOLOR_GRAYTEXT

// Summary: An RGB value that represents the XP menu item checked color.
#ifndef XPCOLOR_HIGHLIGHT_CHECKED
#define XPCOLOR_HIGHLIGHT_CHECKED			36
#endif//XPCOLOR_HIGHLIGHT_CHECKED

// Summary: An RGB value that represents the XP menu item checked border color.
#ifndef XPCOLOR_HIGHLIGHT_CHECKED_BORDER
#define XPCOLOR_HIGHLIGHT_CHECKED_BORDER	37
#endif//XPCOLOR_HIGHLIGHT_CHECKED_BORDER


// Summary: An RGB value that represents the XP toolbar gripper color.
#ifndef XPCOLOR_GRIPPER
#define XPCOLOR_GRIPPER				38
#endif//XPCOLOR_GRIPPER

// Summary: An RGB value that represents the XP toolbar separator color.
#ifndef XPCOLOR_SEPARATOR
#define XPCOLOR_SEPARATOR					39
#endif//XPCOLOR_SEPARATOR

// Summary: An RGB value that represents the XP menu icon disabled color.
#ifndef XPCOLOR_DISABLED
#define XPCOLOR_DISABLED					40
#endif//XPCOLOR_DISABLED

// Summary: An RGB value that represents the XP menu item text background color.
#ifndef XPCOLOR_MENUTEXT_BACK
#define XPCOLOR_MENUTEXT_BACK				41
#endif//XPCOLOR_MENUTEXT_BACK

// Summary: An RGB value that represents the XP hidden menu commands background color.
#ifndef XPCOLOR_MENU_EXPANDED
#define XPCOLOR_MENU_EXPANDED			42
#endif//XPCOLOR_MENU_EXPANDED

// Summary: An RGB value that represents the XP menu border color.
#ifndef XPCOLOR_MENU_BORDER
#define XPCOLOR_MENU_BORDER				43
#endif//XPCOLOR_MENU_BORDER

// Summary: An RGB value that represents the XP menu item text color.
#ifndef XPCOLOR_MENUTEXT
#define XPCOLOR_MENUTEXT				44
#endif//XPCOLOR_MENUTEXT

// Summary: An RGB value that represents the XP menu item selected text color.
#ifndef XPCOLOR_HIGHLIGHT_TEXT
#define XPCOLOR_HIGHLIGHT_TEXT				45
#endif//XPCOLOR_HIGHLIGHT_TEXT

// Summary: An RGB value that represents the XP toolbar text color.
#ifndef XPCOLOR_BARTEXT
#define XPCOLOR_BARTEXT				46
#endif//XPCOLOR_BARTEXT

// Summary: An RGB value that represents the XP toolbar pushed text color.
#ifndef XPCOLOR_BARTEXT_PUSHED
#define XPCOLOR_BARTEXT_PUSHED					47
#endif//XPCOLOR_BARTEXT_PUSHED

// Summary: An RGB value that represents the XP inactive tab background color.
#ifndef XPCOLOR_TAB_INACTIVE_BACK
#define XPCOLOR_TAB_INACTIVE_BACK			48
#endif//XPCOLOR_TAB_INACTIVE_BACK

// Summary: An RGB value that represents the XP inactive tab text color.
#ifndef XPCOLOR_TAB_INACTIVE_TEXT
#define XPCOLOR_TAB_INACTIVE_TEXT			49
#endif//XPCOLOR_TAB_INACTIVE_TEXT

// Summary: An RGB value that represents the XP border color for pushed in 3D elements.
#ifndef XPCOLOR_HIGHLIGHT_PUSHED_BORDER
#define XPCOLOR_HIGHLIGHT_PUSHED_BORDER		50
#endif//XPCOLOR_HIGHLIGHT_PUSHED_BORDER

// Summary: An RGB value that represents the XP color for text displayed in a checked
//			button.
#ifndef XPCOLOR_CHECKED_TEXT
#define XPCOLOR_CHECKED_TEXT				XPCOLOR_HIGHLIGHT_TEXT
#endif//XPCOLOR_CHECKED_TEXT

#ifndef XPCOLOR_3DFACE
#define XPCOLOR_3DFACE						51
#endif//XPCOLOR_3DFACE

// Summary: An RGB value that represents thte XP shadow color for three-dimensional 
//			display elements (for edges facing away from the light source).
#ifndef XPCOLOR_3DSHADOW
#define XPCOLOR_3DSHADOW					52
#endif//XPCOLOR_3DSHADOW

#define XPCOLOR_SPLITTER_FACE	COLOR_3DFACE
...
const UINT CBRS_XT_BUTTONS_FLAT    = 0x0020; // Draws buttons flat.  Only valid with CBRS_XT_BUTTONS style.
const UINT CBRS_XT_BORDERS_FLAT    = 0x0040; // Draws the borders flat.
const UINT CBRS_XT_SEMIFLAT        = 0x0080; // Draws buttons and borders with a thin 3D border.
const UINT CBRS_XT_CLIENT_OUTLINE  = 0x0100; // Draws an outline around the client area.
const UINT CBRS_XT_CLIENT_STATIC   = 0x0200; // Draws a static rect around the client area.
const UINT CBRS_XT_CLIENT_MODAL    = 0x0400; // Draws a modal rect around the client area.
const UINT CBRS_XT_NEWDOCKED       = 0x0800; // Used internally by docking windows.
const UINT CBRS_XT_CLOSEBTN        = 0x1000; // Has close frame button.
const UINT CBRS_XT_MINMAXBTN       = 0x2000; // Has min/max frame button.
const UINT CBRS_XT_NOFLOAT         = 0x4000; // Docking window cannot be floated from its docked state.
const UINT CBRS_XT_BUTTONS         = (CBRS_XT_CLOSEBTN|CBRS_XT_MINMAXBTN); // Has min, max, and close frame buttons.
const UINT CBRS_XT_DEFAULT         = (CBRS_XT_CLOSEBTN|CBRS_XT_MINMAXBTN|CBRS_XT_GRIPPER|CBRS_XT_GRIPPER_TEXT); // Same as CBRS_XT_CLOSEBTN|CBRS_XT_MINMAXBTN|CBRS_XT_GRIPPER|CBRS_XT_GRIPPER_TEXT.
const UINT CBRS_XT_ALL_FLAT        = (CBRS_XT_DEFAULT|CBRS_XT_GRIPPER_FLAT|CBRS_XT_BUTTONS_FLAT|CBRS_XT_BORDERS_FLAT); // Same as CBRS_XT_DEFAULT|CBRS_XT_GRIPPER_FLAT|CBRS_XT_BUTTONS_FLAT|CBRS_XT_BORDERS_FLAT.
...
//			[li]<b>SHN_XT_LISTRESTART</b> Directory monitoring thread needs to be restarted[/li]
//			[li]<b>SHN_XT_LISTUPDATE</b> Directory contents have been changed and list needs to be updated.[/li]
//			[/ul]
...
const UINT SHN_XT_LISTRESTART   = 6; // Directory monitoring thread needs to be restarted.  See XTWM_SHELL_NOTIFY.
const UINT SHN_XT_LISTUPDATE    = 7; // Directory contents have been changed and list needs to be updated.  See XTWM_SHELL_NOTIFY.
