...
public:
	...
	// Input:	iVal - Specifies the color intensity that is the source of 
	//			the operation.
	//			iAdd - Specifies the intensity to add to the source. It can be 
	//			negative.
	// Summary: This member function adds two color intensities to ensure that the
	...
	// Input:	iVal - Specifies the color intensity that is the source of the operation.
	...
	//			0 and 255.  Anything out of range will be adjusted to the closest number
