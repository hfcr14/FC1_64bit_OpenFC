...
public:
	...
	//			one of the button states. To only retrieve one state, use one of the
	...
	//			grayed, the way the bold button on the toolbar of a word processor
	//			looks when the selected text contains both bold and regular characters.
    //
    //			If you want to change more than one button state, consider calling
	//			SetState instead. 
...
public:
	...
	//			variables, in CMainFrame, are properly initialized.  Next, this function
	...
	// Input:	dimensionCurrent - Current total size of the buttons hidden.
	...
	//			dimension - Current visible toolbar size.
	//			bHorz - true if the toolbar is horizontally oriented.
	// Returns: An integer value that represents the current compaction of the buttons.
	...
	//			oriented. Set if the bar is horizontally oriented; if the bar
...
protected:
	...
	// Input:	lpszText - A NULL terminated string.
	...
	//			result returned is suitable to be assigned to TBBUTTON.iString member
